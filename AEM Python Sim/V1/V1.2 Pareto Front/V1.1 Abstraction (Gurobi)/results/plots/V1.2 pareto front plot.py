...
CSV_PATH = "/workspaces/BAT/AEM Python Sim/V1/V1.2 Pareto Front/V1.1 Abstraction (Gurobi)/results/V1.2 Pareto 50 steps.csv"
HTML_OUTPUT_PATH = "/workspaces/BAT/AEM Python Sim/V1/V1.2 Pareto Front/V1.1 Abstraction (Gurobi)/results/plots/V1.2 pareto front plot.html"
PARETO_CURRENT_STATE_CSV_PATH = (
    Path(__file__).resolve().parents[5]
    / "V0"
    / "Current State"
    / "pareto_annual_summary.csv"
)
RP_PER_CHF = 100.0
